...
describe('bowling',() => {
  ...
  it('should return a next bonus points from next ball rolled', () => {
    expect(bowling([{ball1: 5 ,ball2: 5},{ball1: 5 ,ball2: 0},{ball1: 0 ,ball2: 0},{ball1: 0 ,ball2:0},{ball1: 0 ,ball2:0},{ball1: 0 ,ball2:0},{ball1: 0 ,ball2:0},{ball1: 0 ,ball2:0},{ball1: 0 ,ball2:0},{ball1: 0 ,ball2:0}])).to.equal(15);
  });
  it('should return next bonus points from the next two balls rolled', () => {
    expect(bowling([{ball1: 10 ,ball2: 0},{ball1: 1 ,ball2: 2},{ball1: 0 ,ball2: 0},{ball1: 0 ,ball2:0},{ball1: 0 ,ball2:0},{ball1: 0 ,ball2:0},{ball1: 0 ,ball2:0},{ball1: 0 ,ball2:0},{ball1: 0 ,ball2:0},{ball1: 0 ,ball2:0}])).to.equal(13);
  });
